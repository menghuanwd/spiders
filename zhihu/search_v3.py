...
with open('./zhihu/zhihu_zse_96.js', 'r', encoding='utf-8') as f:
    das = f.read()
...
# url = 'https://www.zhihu.com/api/v4/search_v3?gk_version=gz-gaokao&t=general&q=%E4%B8%80%E5%8A%A0%E6%89%8B%E6%9C%BA&correction=1&offset=0&limit=20&filter_fields=&lc_idx=0&show_all_topics=0&search_source=Normal'
